...
\institute[UTSA, U. Toronto]{
    ...
    ISQGD Special Session on Ergodic Theory and Topological Dynamics \and
    22 March 2026
}
\date{}
...
\begin{frame}{The Rosetta Stone}
    ...
    \begin{tikzpicture}[node distance=3cm, auto, thick]
        ...
        \node[draw=utsaNavy, fill=utsaOrange!20, rounded corners, align=center] (Learn) [below right of=Topo] {\textbf{Learning Theory}\\ VC Dimension \\ (Vapnik-Chervonenkis)};
